...
dens <- 0.501 # juveniles per unit area enhanced by restoration
m <- 1.39 # annual mortality rate
t_max <- 16 # maximum age
t_0 <- -1.17 # theoretical age when length is 0
t_harv <- 1 # age of recruitment to fishery
l_asym <- 27 # asymptotic size (length in cm)
Ks <- 0.69 # Brody growth coef 
a <- 0.0114 # intercept of length-weight relationship
b <- 3 # slope of length-weight relationship
...
points(x = enhancement$year, y = enhancement$net_biomass_g_unit_area)
